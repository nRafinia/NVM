...
public class ImagesListParserTests
{
    private const string RawResult =
        "[{\"Containers\":-1,\"Created\":1692862297,\"Id\":\"sha256:2552cbe87d6db5ffe84a9d2053b1728905be28a82b0effd114bdc1897eaa362b\",\"Labels\":{\"maintainer\":\"Emby LLC <apps@emby.media>\"},\"ParentId\":\"\",\"RepoDigests\":[\"emby/embyserver@sha256:fe2044bd3cd3b22dd38c77c1d05c50588520bc6b4083a36e8062dc08e923599f\"],\"RepoTags\":[\"emby/embyserver:latest\"],\"SharedSize\":-1,\"Size\":571411119,\"VirtualSize\":571411119}]";

    [Fact]
    public void Parse_Return_Success()
    {
        //arrange
        var jsonData = JsonSerializer.Deserialize<List<ImageRaw>>(RawResult);
        ...
        Assert.Equal(24, convertor[0].CreatedAt.Day);
    ...
    {
        //arrange
        var jsonDataEmpty =new List<ImageRaw>(0);
